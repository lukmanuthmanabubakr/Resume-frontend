          ...
          >
            ...
            <div className="mt-4">
              ...
              <textarea
                ...
                className="mt-1 w-full text-sm text-gray-800 bg-white border border-gray-300 rounded-lg p-3 outline-none shadow-sm 
      placeholder:text-gray-400
      focus:border-purple-400 focus:ring-2 focus:ring-purple-300 transition-all duration-200 resize-none"
                rows={3}
