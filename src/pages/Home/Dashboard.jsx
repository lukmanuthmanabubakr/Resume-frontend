    ...
    <DashboardLayout>
      <div className="w-full px-4 md:px-10 py-8">
        ...
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between mb-10">
          ...
          <button
            onClick={() => setOpenCreateModal(true)}
            className="mt-5 md:mt-0 flex items-center gap-2 bg-[#7b3eff] hover:bg-[#5f1de0] text-white font-medium px-5 py-2.5 rounded-xl shadow-sm transition-all duration-300"
          >
            <Plus size={18} />
            Create New Resume
          </button>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
          ...
          <div
            onClick={() => setOpenCreateModal(true)}
            className="group border-2 border-dashed border-gray-300 bg-gray-50 hover:border-[#7b3eff] hover:bg-[#f8f4ff] 
             rounded-2xl shadow-sm hover:shadow-md transition-all duration-300 flex flex-col items-center justify-center cursor-pointer h-[340px]"
          >
            <div className="w-16 h-16 rounded-full bg-[#7b3eff]/10 flex items-center justify-center mb-3 group-hover:bg-[#7b3eff]/20 transition-all">
              <Plus className="text-[#7b3eff]" size={32} />
            </div>
            <h3 className="text-base font-semibold text-gray-700 group-hover:text-[#7b3eff] transition-all">
              Add New Resume
            </h3>
          </div>
          ...
          {allResumes.length > 0 ? (
            ...
            <p className="col-span-full text-gray-500 text-center mt-10 text-sm">
