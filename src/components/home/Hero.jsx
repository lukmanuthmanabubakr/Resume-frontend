...
const Hero = () => {
  ...
  return (
    <>
      <div className="min-h-screen overflow-x-hidden bg-gradient-to-br from-white via-green-50/30 to-green-100/40">
        {/* Navbar */}
        <nav className="relative z-50 flex items-center justify-between w-full py-5 px-6 md:px-12 lg:px-20">
          ...
          <div className="hidden lg:flex items-center gap-1 bg-white/80 backdrop-blur-sm rounded-full px-2 py-2 shadow-sm border border-gray-200">
            <a
              href="#"
              className="px-5 py-2 rounded-full text-sm font-medium text-gray-700 hover:bg-green-50 hover:text-green-700 transition"
            >
              Home
            </a>
            <a
          ...
          <div className="fixed inset-0 z-[100] lg:hidden">
            ...
            <div className="absolute right-0 top-0 bottom-0 w-72 bg-white shadow-2xl p-6 flex flex-col">
              ...
              <div className="flex flex-col gap-2">
                <a
                  href="#"
                  className="px-4 py-3 text-gray-700 hover:bg-green-50 hover:text-green-700 rounded-lg transition"
                >
                  Home
                </a>
                <a
        ...
        {/* Hero Section */}
        <div className="hero-wrapper relative px-6 md:px-12 lg:px-20 py-16 md:py-24">
          {/* Decorative elements */}
          ...
          <div className="relative max-w-6xl mx-auto">
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="space-y-8">
                ...
                {/* Heading */}
                <div>
                  <h1 className="text-3xl xs:text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 leading-tight">
                  ...
                  <p className="mt-6 text-lg text-gray-600 leading-relaxed">
                    Let AI craft a professional resume tailored to your
                    experience. No design skills needed—just your career story.
                  </p>
                </div>
    ...
    * {
    ...
    /* ===== FIX FOR SMALL SCREENS (below 330px) ===== */
    @media (max-width: 330px) {
      ...
      .hero-text {
        font-size: 1.9rem !important;  /* shrink heading */
