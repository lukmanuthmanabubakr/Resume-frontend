    ...
    <footer className="w-full bg-gradient-to-b from-green-900 to-green-950 text-white">
      <div className="max-w-7xl mx-auto px-6 py-16 flex flex-col items-center">
        ...
        <p className="text-center max-w-xl text-sm font-normal leading-relaxed text-green-100">
          Empowering job seekers worldwide with AI-powered resume building
          tools. Create professional, ATS-friendly resumes that help you land
          your dream job.
        </p>
        ...
        <div className="flex items-center gap-4 mt-8">
          <a
            ...
            className="w-10 h-10 flex items-center justify-center rounded-full bg-green-800 hover:bg-green-700 transition"
            aria-label="GitHub"
          >
          ...
          <a
            href="https://www.linkedin.com/in/abubakr-lukman-uthman-51156a263?utm_source=share_via&utm_content=profile&utm_medium=member_ios"
            target="_blank"
            rel="noopener noreferrer"
            className="w-10 h-10 flex items-center justify-center rounded-full bg-green-800 hover:bg-green-700 transition"
            aria-label="LinkedIn"
          ...
          <a
            href="https://twitter.com/dimeji_911"
            target="_blank"
            rel="noopener noreferrer"
            className="w-10 h-10 flex items-center justify-center rounded-full bg-green-800 hover:bg-green-700 transition"
          ...
          <a
            href="https://instagram.com/devabubakr_"
            target="_blank"
            rel="noopener noreferrer"
            className="w-10 h-10 flex items-center justify-center rounded-full bg-green-800 hover:bg-green-700 transition"
