    ...
    <div className="space-y-4">
      ...
      <div className="mt-6">
        <textarea
          ...
          rows={7}
          className="w-full p-3 px-4 mt-2 border text-sm border-gray-300 rounded-1g focus: ring focus: ring-blue-500 focus: border-blue-500 outline-none transition-colors resize-none"
